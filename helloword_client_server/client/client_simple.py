...
server_params = StdioServerParameters(
    command="uv",
    args=["run", "weather.py"]
    #args=["--directory", "C:\\Users\\Lenovo\\mcp_examples\\helloword_client_server\\client\\server.py", "run", "server.py"],  # Optional command line arguments
)
    ...
    try:
        ...
        async with stdio_client(server_params) as (read, write):
            ...
            async with ClientSession(read, write) as session:
                ...
                print("Calling tool...")
                result = await session.call_tool("get_weather", arguments={"location": "Machakos, Kenya"})
